# CPC Data Summary
This file is to summarize CPC Data for SCOPE deployments - essentially a copy of `SCOPE_modulair_summarizing.Rmd`
...
```{r}
write_csv(summary, "data_summarized/summary_SCOPE_cpc_raw.csv")
write_csv(summary_redu, "data_summarized/summary_SCOPE_cpc_redu.csv")
```
