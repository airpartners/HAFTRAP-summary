# Mod-PM Data Summary
This file is to summarize Modulair-PM Data for Olin deployments
...
```{r}
write_csv(summary, "data_summarized/summary_Olin_modpm_raw.csv")
write_csv(summary_redu, "data_summarized/summary_Olin_modpm_redu.csv")
```
