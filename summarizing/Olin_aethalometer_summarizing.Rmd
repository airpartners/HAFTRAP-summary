# Aethalometer Data Summary
This file is to summarize Aethalometer Data for Olin deployments
...
```{r}
write_csv(summary, "data_summarized/summary_Olin_aethalometer_raw.csv")
write_csv(summary_redu, "data_summarized/summary_Olin_aethalometer_redu.csv")
```
