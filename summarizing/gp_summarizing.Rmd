# Gas Phase Data Summary
This file summarizes all gas phase data from Modulairs in Olin and SCOPE deployments
...
```{r}
write_csv(summary, "data_summarized/summary_gp_raw.csv")
write_csv(summary_redu, "data_summarized/summary_gp_redu.csv")
```
