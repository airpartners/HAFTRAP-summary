# CPC Data Summary
This file is to summarize CPC Data for Olin deployments
...
```{r}
write_csv(summary, "data_summarized/summary_Olin_cpc_raw.csv")
write_csv(summary_redu, "data_summarized/summary_Olin_cpc_redu.csv")
```
