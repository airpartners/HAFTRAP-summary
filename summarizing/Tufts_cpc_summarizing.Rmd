# CPC Data Summary
This file summarizes CPC Data for Tufts deployments
...
```{r}
write_csv(summary, "data_summarized/summary_Tufts_cpc_raw.csv")
write_csv(summary_redu, "data_summarized/summary_Tufts_cpc_redu.csv")
```
